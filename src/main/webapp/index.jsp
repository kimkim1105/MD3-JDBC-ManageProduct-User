...
<div id="top-bar" class="container">
    <div class="row">
        <div class="span4">
            <form method="POST" action="/products" class="search_form">
                <input type="text" name="search" class="input-block-level search-query" Placeholder="eg. T-sirt">
            </form>
        </div>
        ...
        <div class="span8">
            <div class="account pull-right">
                <ul class="user-menu">
                    ...
                    <li><a href="user/register.jsp">Login</a></li>
                </ul>
            </div>
        </div>
        </form>
    </div>
</div><form action="/products">
                                        ...
                                        <c:forEach begin="0" end="${products.size()-1}" var="i">
                                            <li class="span3">
                                                <div class="product-box">
                                                    ...
                                                    <p><a href="/products?action=view&id=${products.get(i).id}"><img
                                                            src="themes/images/ladies/1.jpg" alt=""/></a></p>
                                                    <a href="/products?action=view&id=${products.get(i).id}"
                                                       class="title">${products.get(i).name}</a><br/>
                                                    <a href="products.html"
                                                       class="category">${categories.get(i).name}</a>
                                                    <p class="price">${products.get(i).price}</p>
                                                    <p class="category"><a href="/products?action=edit&id=${products.get(i).id}">Edit</a></p>
                                                </div>
                                            </li>
                                        </c:forEach>
