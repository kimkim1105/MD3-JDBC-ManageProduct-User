        ...
        <div class="row">
            <div class="span9">
                <div class="row">
                    ...
                    <div class="span5">
                        <address>
                            <strong>Name:</strong> <span><input type="text" name="name"
                                                                value="${product.name}"></span><br>
...
<%--                            <strong>Availability:</strong> <span>Out Of Stock</span><br>--%>
                        ...
                        <h4><strong>Price: <input type="text" name="price" value="${product.price}"></strong></h4>
                    </div>
                    <div class="span5">
                        <button class="btn btn-inverse" type="submit">Update</button>
                        <button class="btn btn-inverse" type="submit" ><a href="/products?action=delete&id=${product.id}">Delete</a></button>
